...
export const getSystemjsPath = (): string => {
  return `var sj = '${browser.runtime.getURL('bundles/system.js')}';`
}
export const getPnpjsPath = (): string => {
  return `var mod_sp = '${browser.runtime.getURL('bundles/sp.es5.umd.bundle.js')}';
  var mod_logging = '${browser.runtime.getURL('bundles/logging.es5.umd.bundle.js')}';
  var mod_queryable = '${browser.runtime.getURL('bundles/queryable.es5.umd.bundle.js')}';`
}
...
export const getExtensionDirectory = (): Promise<DirectoryEntry> =>
  new Promise(resolve => browser.runtime.getPackageDirectoryEntry(resolve))